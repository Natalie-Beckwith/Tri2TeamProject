...
<div class="calendar">
    ...
    <input type="text" id="year1" name="year1" value="2000"><br>
    <label for="year2">Enter the second year:</label><br>
    <input type="text" id="year2" name="year1" value="2022"><br><br>
...
<script>
  document.getElementById('form').addEventListener('submit', (event) => {
    ...
    fetch(`${"https://flask.nighthawkcodingsociety.com/api/calendar"}/${cleanInput}`)
...
<script>
  ...
  // prepare fetch urls
  // const url = "https://flask.nighthawkcodingsociety.com/api/calendar";
  const url = "https://blognorte.tk/api/calendar/isLeapYear/2000";
  const get_url = url +"/";
